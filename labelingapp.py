...
class PongGame(Widget):
    ...
    def getNextImg(imgList):
        ...
        PongGame.currentTxtfileLocation = jpgToTxt(PongGame.imgList[PongGame.currentImg]) # stores txt file path for this iteration
        PongGame.currentJpgFileLocation = PongGame.imgList[PongGame.currentImg] # stores jpg location for this iteration
